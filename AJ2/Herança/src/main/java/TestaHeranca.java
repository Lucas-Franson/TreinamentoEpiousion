...
public class TestaHeranca {
    ...
    public static void main(String args[]) {
        ...
        contaEsp1 = new ContaEspecial(1000, "123", cliente1, ag1, 2000);
        contaEsp1.saque(1250);
        
        ContaEspecial contaEsp2 = null; // 2a. conta especial
        contaEsp2 = new ContaEspecial(1250, "345", cliente2, ag1, 2000);
        contaEsp2.saque(3600);
        
        ContaPoupanca contaPoup = null; // conta poupanca
        contaPoup = new ContaPoupanca(1240, "654", cliente1, ag1, "23/11/2000");
