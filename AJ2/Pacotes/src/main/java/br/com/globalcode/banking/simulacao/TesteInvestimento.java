...
public class TesteInvestimento {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 3) {
            ...
            System.out.println("br.com.globalcode.banking.simulacao.TesteInvestimento <valor aplicado> <taxa de rendimento mensal> <meses para aplicacao>");
            System.out.println("ex.: br.com.globalcode.banking.simulacao.TesteInvestimento 1300.00 0.016 12");
            return;
        }
